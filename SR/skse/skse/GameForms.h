...
public:
	...
	UInt8						unk32;			// 32
	UInt8						pad33;			// 33
	BSExtraData*				extraData;		// 34 - ExtraDataList: ExtraEditorID, ExtraCellImageSpace, ExtraCellMusicType, ExtraLocation, ExtraEncounterZone, ExtraCellAcousticSpace, ExtraSeenData, ExtraHavok
	UInt32						unk38;			// 38
	union { ExteriorData* exteriorData; InteriorData* interiorData; }; // 3C
	UInt32						unk40;			// 40
